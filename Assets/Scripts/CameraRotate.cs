...
public class CameraRotate : MonoBehaviour
{
    ...
    public float rotAmountX = 15F;
    public float rotAmountY = 15F;
    ...
    void Update()
    {
        if (Time.timeScale == 0) { return; }
            ...
            rotationY += Input.GetAxis("Mouse Y") * rotAmountY * mouseSensitivity;
            rotationX += Input.GetAxis("Mouse X") * rotAmountX * mouseSensitivity;
